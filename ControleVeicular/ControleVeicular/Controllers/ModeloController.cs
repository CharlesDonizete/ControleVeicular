...
namespace ControleVeicular.Controllers
{
    public class ModeloController : Controller
    {
        ...
        public ModeloController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Descricao,Id")] Modelo modelo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Descricao,Id")] Modelo modelo)
        {
            if (id != modelo.Id)
            {
                return NotFound();
